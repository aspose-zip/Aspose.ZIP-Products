...
{{< blocks/products/pf/i18n/upper-banner h1=".NET API để nén và lưu trữ tệp" h2="Nén tệp để tạo tệp lưu trữ hoặc Giải nén tệp lưu trữ các loại ZIP, 7Zip, RAR, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB từ bên trong bất kỳ ứng dụng dựa trên .NET nào." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/headers/aspose_zip-for-net.svg" pfName="Aspose.ZIP" subTitlepfName="for .NET" downloadUrl="https://downloads.aspose.com/zip/net" >}}
...
<p>Aspose.ZIP for .NET là một API thao tác nén và lưu trữ tài liệu linh hoạt cho định dạng ZIP tiêu chuẩn. API cho phép các ứng dụng .NET đạt được khả năng nén / giải nén tệp, lưu trữ tệp cũng như thư mục và mã hóa tệp lưu trữ. API này hoạt động với tất cả các định dạng lưu trữ nổi tiếng: ZIP, RAR, 7Zip, GZIP, BZ2. Và với nhiều định dạng lưu trữ từ Linux: CPIO, TAR, Lzip, Bzip2, XZ, Z. Nó cung cấp khả năng bảo vệ thông qua mật khẩu do người dùng xác định và mã hóa truyền thống sử dụng mã hóa ZipCrypto hoặc AES như AES128, 192 và AES256.</p>
...
{{< blocks/products/pf/carousel-item h3="Sơ lược" description="Tổng quan về Aspose.ZIP cho .NET API." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
   ...
   <ul>
    ...
    <li>
     Soạn một kho lưu trữ
    </li>
    <li>
     Thêm tệp vào kho lưu trữ
    </li>
    <li>
     Xóa mục nhập khỏi kho lưu trữ
    </li>
   </ul>
  </div>
  <!--/left-->
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API xử lý tệp ZIP .NET" src="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg"/>
  <header>
   Aspose.ZIP
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Nền tảng độc lập" description="Aspose.ZIP for .NET hỗ trợ mọi khuôn khổ .NET bắt đầu từ Tiêu chuẩn 2.0 và có thể hoạt động trên hệ điều hành 32 bit & 64 bit." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
 ...
 <!--/row-->
 <div class="d1-logo">
  <img width="70" height="75" alt="API chuyển đổi PostScript" src="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg"/>
  <header>
   Aspose.ZIP
  </header>
  <footer>
...
{{< blocks/products/pf/carousel-item h3="Các định dạng tệp được hỗ trợ" description="Hỗ trợ Aspose.ZIP cho .NET [chuẩn ZIP](https://docs.aspose.com/zip/net/supported-file-formats/)  các định dạng tệp." >}}
...
{{< blocks/products/pf/slr-element name="Tài liệu" href="https://docs.aspose.com/zip/net/" >}}
{{< blocks/products/pf/slr-element name="Mã nguồn" href="https://github.com/aspose-zip/Aspose.ZIP-for-.NET" >}}
{{< blocks/products/pf/slr-element name="Tham chiếu API" href="https://apireference.aspose.com/zip/net" >}}
{{< blocks/products/pf/slr-element name="Video hướng dẫn" href="https://www.youtube.com/user/asposevideo" >}}
{{< /blocks/products/pf/slr-tab >}}

{{< blocks/products/pf/slr-tab tabTitle="Hỗ trợ sản phẩm" tabId="support" >}}
{{< blocks/products/pf/slr-element name="Hỗ trợ miễn phí" href="https://forum.aspose.com/c/zip" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Tại sao sử dụng Aspose.ZIP cho .NET?" tabId="success-stories" >}}
