---
title: Extract ICO Files via .NET 
weight: 1280
url: /net/extract/ico/ 
description: C# decompression source code to extract ICO documents from a single archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Extract ICO Formats in C#" h2="Native and high performance ICO document ZIP, 7Zip, RAR, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive decompression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ICO" >}}
...
{{% blocks/products/pf/agp/content h2="How to Extract ICO File Using C#" %}}

 In order to extract ICO file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for ICO Files Decompression in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Extract ICO Files - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online ICO Decompression Live Demos" sectionDescription="Extract ICO documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/extract). The live demo has the following benefits" >}}
