---
title: Convert TAR to TAR.BZ2 via C# 
weight: 1010
url: /net/conversion/tar-to-tarbz2/ 
description: Source code for TAR to TAR.BZ2 C# conversion. Use API example code for batch TAR files to TAR.BZ2 conversion within VB.NET Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Convert TAR to TAR.BZ2 via C#" h2="Extract entries from TAR archive and immediately put it to TAR.BZ2 archive" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Convert TAR to TAR.BZ2 Using C#" %}}

 In order to convert TAR to TAR.BZ2, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Convert TAR to TAR.BZ2 via C#" %}}
...
<div class="codeblock" id="code">
     <h3>
      Convert from TAR archives to TAR.BZ2 - C#
     </h3>
     <pre><code class="cs">
     using (Bzip2Archive archive = new Bzip2Archive())
{
	archive.SetSource("source1.tar");
	archive.Save("output.tar.xz");
}
</code></pre>
</div>
...
{{< blocks/products/pf/agp/demobox sectionTitle="Free App to Convert TAR to TAR.BZ2" sectionDescription="Check our live demos for [TAR to TAR.BZ2 conversion](https://products.aspose.app/zip/conversion/tar-to-tarbz2) with following benefits." >}}
