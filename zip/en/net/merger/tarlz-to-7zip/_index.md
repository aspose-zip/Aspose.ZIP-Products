---
title: Merge TAR.LZ files to one 7ZIP archive via C# 
weight: 910
url: /net/merger/tarlz-to-7zip/
description: Source code for merge TAR.LZ files to one 7ZIP archive via C#. Use API example code for combine TAR.LZ files to a single 7ZIP within VB.NET Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge TAR.LZ files to one 7ZIP archive via C#" h2="Combine TAR.LZ archive and immediately put it to single 7ZIP archive" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge several TAR.LZ files to a single 7ZIP using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge TAR.LZ archives to one 7ZIP via C#" %}}
...
<div class="codeblock" id="code">
     <h3>
      Merge two TAR.LZ archives to 7ZIP - C#
     </h3>
     <pre><code class="cs">
     string intermediateStorage = "storage";
	DirectoryInfo stored = Directory.CreateDirectory(intermediateStorage);
	using (TarArchive source1 = TarArchive.FromLZip("source1.tar.lz"))
		source1.ExtractToDirectory(intermediateStorage);
	using (TarArchive source2 = TarArchive.FromLZip("source2.tar.lz"))
