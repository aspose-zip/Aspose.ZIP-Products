---
title: Merge ZIP files to one ZIP archive via C# 
weight: 910
url: /net/merger/zip-to-zip/
description: Source code for merge ZIP files to one ZIP archive via C#. Use API example code for combine ZIP files to a single ZIP within VB.NET Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge ZIP files to one ZIP archive via C#" h2="Combine ZIP archive and immediately put it to single ZIP archive" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge several ZIP files to a single ZIP using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge ZIP archives to one ZIP via C#" %}}
