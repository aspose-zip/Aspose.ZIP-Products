---
title: Merge RAR files to one TAR.XZ archive via C# 
weight: 910
url: /net/merger/rar-to-tarxz/
description: Source code for merge RAR files to one TAR.XZ archive via C#. Use API example code for combine RAR files to a single TAR.XZ within VB.NET Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge RAR files to one TAR.XZ archive via C#" h2="Combine RAR archive and immediately put it to single TAR.XZ archive" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge several RAR files to a single TAR.XZ using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge RAR archives to one TAR.XZ via C#" %}}
...
<div class="codeblock" id="code">
     <h3>
      Merge two RAR archives to TAR.XZ - C#
     </h3>
     <pre><code class="cs">
