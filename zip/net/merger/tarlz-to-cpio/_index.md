---
title: Merge TAR.LZ files to one CPIO archive via C# 
weight: 910
url: /net/merger/tarlz-to-cpio/
description: Source code for merge TAR.LZ files to one CPIO archive via C#. Use API example code for combine TAR.LZ files to a single CPIO within VB.NET Asp.NET or any .NET based application.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Merge TAR.LZ files to one CPIO archive via C#" h2="Combine TAR.LZ archive and immediately put it to single CPIO archive" logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="3DS" >}}
...
{{% blocks/products/pf/agp/content h2="How to Merge several TAR.LZ files to a single CPIO using C#" %}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps to Merge TAR.LZ archives to one CPIO via C#" %}}
