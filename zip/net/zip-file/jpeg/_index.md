---
title: Compress and Decompress JPEG Images via C# 
weight: 560
url: /net/zip-file/jpeg/ 
description: C# compression and decompression source code to compress JPEG images into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress and Decompress JPEG Images in C#" h2="Native and high performance JPEG image ZIP, TAR, GZIP, BZ2 compression and archive decompression using server-side API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress JPEG Image Using C#" %}}
