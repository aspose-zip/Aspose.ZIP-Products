...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress DOCM File Using C#" %}}
 ...
 In order to compress or decompress DOCM file, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 A basic DOCM document compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online DOCM Compression Live Demos" sectionDescription="Compress DOCM documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/zip-file). The live demo has the following benefits" >}}
