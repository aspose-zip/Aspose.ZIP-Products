...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress DOCX File Using C#" %}}
 ...
 In order to compress or decompress DOCX file, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 A basic DOCX document compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online DOCX Compression Live Demos" sectionDescription="Compress DOCX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/zip-file). The live demo has the following benefits" >}}
