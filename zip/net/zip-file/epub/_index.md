---
title: Compress and Decompress EPUB Files via .NET 
weight: 440
...
{{< blocks/products/pf/upper-banner h1="Compress and Decompress EPUB Formats in C#" h2="Native and high performance EPUB documentВ ZIP, TAR, GZIP, BZ2 compression and archive decompression using server-side Aspose.ZIP for .NET APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/zip/272x272/aspose_zip-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.ZIP" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="EPUB" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress EPUB File Using C#" %}}

 In order to compress or decompress EPUB file, weвЂ™ll use
...
<!-- aboutfile Starts -->
 ...
 DecompressВ EPUB files right now by visiting our
