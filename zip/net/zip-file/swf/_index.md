---
title: Compress and Decompress SWF Files via .NET 
weight: 1210
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress SWF File Using C#" %}}

 In order to compress or decompress SWF file, weвЂ™ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 A basicВ SWF documentВ compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
...
+  Now youВ will get SWF file as a zip file in a relevant folder without using anyВ zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="CompressВ SWF Files - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 DecompressВ SWF files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online SWFВ Compression Live Demos" sectionDescription="CompressВ SWF documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/zip-file). The live demo has the following benefits" >}}
