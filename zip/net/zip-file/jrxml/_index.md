---
title: Compress and Decompress JRXML Files via .NET 
weight: 630
...
{{< blocks/products/pf/upper-banner h1="Compress and Decompress JRXML Formats in C#" h2="Native and high performance JRXML documentВ ZIP, TAR, GZIP, BZ2 compression and archive decompression using server-side Aspose.ZIP for .NET APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/zip/272x272/aspose_zip-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.ZIP" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JRXML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress JRXML File Using C#" %}}

 In order to compress or decompress JRXML file, weвЂ™ll use
...
<!-- aboutfile Starts -->
 ...
 DecompressВ JRXML files right now by visiting our
