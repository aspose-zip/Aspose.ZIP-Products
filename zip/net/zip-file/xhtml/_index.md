---
title: Compress and Decompress XHTML Files via .NET 
weight: 1510
url: /net/zip-file/xhtml/ 
description: Try our On-Premise document compression and decompression APIs to compress XHTML documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress XHTML File Using C#" %}}

 In order to compress or decompress XHTML file, weвЂ™ll use
...
<!-- aboutfile Starts -->
 ...
 DecompressВ XHTML files right now by visiting our
