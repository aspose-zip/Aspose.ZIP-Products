---
title: Compress and Decompress HTML Files via .NET 
weight: 550
url: /net/zip-file/html/ 
description: Try our On-Premise document compression and decompression APIs to compress HTML documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress HTML File Using C#" %}}

 In order to compress or decompress HTML file, weвЂ™ll use
...
<!-- aboutfile Starts -->
 ...
 DecompressВ HTML files right now by visiting our
