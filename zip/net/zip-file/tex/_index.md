---
title: Compress and Decompress TEX Files via .NET 
weight: 1220
url: /net/zip-file/tex/ 
description: Try our On-Premise document compression and decompression APIs to compress TEX documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress and Decompress TEX Formats in C#" h2="Native and high performance TEX documentВ ZIP, TAR, GZIP, BZ2 compression and archive decompression using server-side Aspose.ZIP for .NET APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/zip/272x272/aspose_zip-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.ZIP" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TEX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress TEX File Using C#" %}}

 In order to compress or decompress TEX file, weвЂ™ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 A basicВ TEX documentВ compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
...
+  Now youВ will get TEX file as a zip file in a relevant folder without using anyВ zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="CompressВ TEX Files - C#" offSpacer="" %}}
...
<!-- aboutfile Starts -->
 ...
 DecompressВ TEX files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online TEXВ Compression Live Demos" sectionDescription="CompressВ TEX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/zip-file). The live demo has the following benefits" >}}
