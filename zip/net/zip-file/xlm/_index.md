---
title: Compress and Decompress XLM Files via .NET 
weight: 1520
url: /net/zip-file/xlm/ 
description: Try our On-Premise document compression and decompression APIs to compress XLM documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress and Decompress XLM Formats in C#" h2="Native and high performance XLM documentВ ZIP, TAR, GZIP, BZ2 compression and archive decompression using server-side Aspose.ZIP for .NET APIs." logoImageSrc="https://www.aspose.com/templates/aspose/App_Themes/V3/images/zip/272x272/aspose_zip-for-net.png" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="Aspose.ZIP" subTitlepfName="for .NET" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="XLM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress XLM File Using C#" %}}

 In order to compress or decompress XLM file, weвЂ™ll use
...
<!-- aboutfile Starts -->
 ...
 DecompressВ XLM files right now by visiting our
