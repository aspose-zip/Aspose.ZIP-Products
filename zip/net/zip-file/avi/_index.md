...
{{% blocks/products/pf/agp/content h2="How to Compress / Decompress AVI File Using C#" %}}
 ...
 In order to compress or decompress AVI file, we’ll use
...
{{% blocks/products/pf/agp/text %}}
 ...
 A basic AVI document compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online AVI Compression Live Demos" sectionDescription="Compress AVI documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/zip-file). The live demo has the following benefits" >}}
