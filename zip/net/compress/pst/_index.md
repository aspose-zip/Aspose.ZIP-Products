---
title: Compress PST Files via .NET 
weight: 1010
url: /net/compress/pst/ 
description: C# compression source code to compress PST documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PST Formats in C#" h2="Native and high performance PST document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PST" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress PST File Using C#" %}}

 In order to compress PST file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for PST Files Compression in C#" %}}
...
{{% blocks/products/pf/agp/code-block title="Compress PST Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "pst-files-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress PST files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PST Compression Live Demos" sectionDescription="Compress PST documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
