---
title: Compress MHTML Files via .NET 
weight: 60
url: /net/compress/mhtml/ 
description: C# compression source code to compress MHTML documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress MHTML Formats in C#" h2="Native and high performance MHTML document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="MHTML" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress MHTML File Using C#" %}}

 In order to compress MHTML file, we’ll use
...
{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-mhtml-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online MHTML Compression Live Demos" sectionDescription="Compress MHTML documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
