---
title: Compress ODG Files via .NET 
weight: 370
url: /net/compress/odg/ 
description: C# compression source code to compress ODG documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress ODG Formats in C#" h2="Native and high performance ODG document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="ODG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress ODG File Using C#" %}}

 In order to compress or decompress ODG file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for ODG Files Compression in C#" %}}
...
+  Define folder path containing ODG files.
...
+  Now you will get ODG file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress ODG Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-odg-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress ODG files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online ODG Compression Live Demos" sectionDescription="Compress ODG documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Just upload your ODG files." >}}
