---
title: Compress JPEG Images via C# 
weight: 560
url: /net/compress/jpeg/ 
description: C# compression source code to compress JPEG images into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress JPEG Images in C#" h2="Native and high performance JPEG image ZIP, TAR, GZIP, BZ2 archive compression using server-side API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="JPEG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress JPEG Image Using C#" %}}

 In order to compress or decompress JPEG image, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for JPEG Images Compression in C#" %}}

{{% blocks/products/pf/agp/text %}}

 A basic JPEG compression or decompression with
 [Aspose.ZIP for .NET](https://products.aspose.com/zip/net) 
 APIs can be done with just few lines of code.

{{% /blocks/products/pf/agp/text %}}

+  Define folder path containing JPEG images.
...
+  Now you will get JPEG file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress JPEG - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-jpeg-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress JPEG images right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online JPEG Compression Live Demos" sectionDescription="Compress JPEG documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Just upload your JPEG files." >}}
