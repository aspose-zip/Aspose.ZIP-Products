---
title: Compress TNEF Files via .NET 
weight: 500
url: /net/compress/tnef/ 
description: C# compression source code to compress TNEF documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress TNEF Formats in C#" h2="Native and high performance TNEF document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="TNEF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress TNEF File Using C#" %}}

 In order to compress TNEF file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for TNEF Files Compression in C#" %}}
...
+  Define folder path containing TNEF files.
...
{{% blocks/products/pf/agp/code-block title="Compress TNEF Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "tnef-files-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress TNEF files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online TNEF Compression Live Demos" sectionDescription="Compress TNEF documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Just upload your TNEF files." >}}
            {{< blocks/products/pf/agp/democard icon="fa-download" text="  You will get compressed archives instantly." >}}

        {{< blocks/products/pf/agp/about-file-text fileFormat="TNEF" readMoreLink="https://docs.fileformat.com/email/tnef/" >}}
Transport Neutral Encapsulation Format (TNEF) is a Microsoft proprietary, for encapsulating email attachments based on Messaging Application Programming Interface (MAPI). Microsoft Outlook and Microsoft Exchange Server, entirely support TNEF while later decodes TNEF into MAPI and displays the formatted mails. An email attachment with TNEF encoding has a MIME type of MS-TNEF and stores as winmail/win.dat. 
