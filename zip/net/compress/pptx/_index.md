---
title: Compress PPTX Files via .NET 
weight: 1060
url: /net/compress/pptx/ 
description: C# compression source code to compress PPTX documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PPTX Formats in C#" h2="Native and high performance PPTX document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress PPTX File Using C#" %}}

 In order to compress or decompress PPTX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for PPTX Files Compression in C#" %}}
...
+  Define folder path containing PPTX files.
...
+  Now you will get PPTX file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress PPTX Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "pptx-file-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress PPTX files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PPTX Compression Live Demos" sectionDescription="Compress PPTX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
