...
{{% blocks/products/pf/agp/content h2="How to Compress HTML File Using C#" %}}

 In order to compress or decompress HTML file, we’ll use
...
+  Now you will get HTML file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress HTML Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-html-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress HTML files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online HTML Compression Live Demos" sectionDescription="Compress HTML documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
