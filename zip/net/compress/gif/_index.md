---
title: Compress GIF Images via C# 
weight: 1070
url: /net/compress/gif/ 
description: C# compression source code to compress GIF Image into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress GIF Images in C#" h2="Native and high performance GIF image ZIP, TAR, GZIP, BZ2 archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="GIF" >}}
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for GIF Images Compression in C#" %}}
...
+  Define folder path containing GIF files.
...
+  Now you will get GIF file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress GIF Images - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-gif-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress GIF images right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online GIF Compression Live Demos" sectionDescription="Compress GIF documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
