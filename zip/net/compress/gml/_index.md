...
{{% blocks/products/pf/agp/content h2="How to Compress GML File Using C#" %}}

 In order to compress or decompress GML file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for GML Files Compression in C#" %}}
...
+  Define folder path containing GML files.
...
+  Now you will get GML file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress GML Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "create-zip-archive-of-gml-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress GML files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online GML Compression Live Demos" sectionDescription="Compress GML documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
            {{< blocks/products/pf/agp/democard icon="fa-cogs" text=" No need to download Aspose API." >}}
            {{< blocks/products/pf/agp/democard icon="fa-edit" text=" No need to write any code." >}}
            {{< blocks/products/pf/agp/democard icon="fa-file-text" text="Just upload your GML files." >}}
