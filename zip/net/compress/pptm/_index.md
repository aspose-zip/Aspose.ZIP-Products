---
title: Compress PPTM Files via .NET 
weight: 600
url: /net/compress/pptm/ 
description: C# compression source code to compress PPTM documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PPTM Formats in C#" h2="Native and high performance PPTM document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PPTM" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress PPTM File Using C#" %}}

 In order to compress or decompress PPTM file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for PPTM Files Compression in C#" %}}
...
+  Define folder path containing PPTM files.
...
+  Now you will get PPTM file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress PPTM Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "pptm-file-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress PPTM files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PPTM Compression Live Demos" sectionDescription="Compress PPTM documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
