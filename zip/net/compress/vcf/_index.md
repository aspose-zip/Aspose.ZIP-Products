---
title: Compress VCF Files via .NET 
weight: 540
url: /net/compress/vcf/ 
description: C# compression source code to compress VCF documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress VCF Formats in C#" h2="Native and high performance VCF document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VCF" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress VCF File Using C#" %}}

 In order to compress or decompress VCF file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for VCF Files Compression in C#" %}}
...
+  Define folder path containing VCF files.
...
+  Now you will get VCF file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress VCF Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "vcf-files-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress VCF files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VCF Compression Live Demos" sectionDescription="Compress VCF documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
