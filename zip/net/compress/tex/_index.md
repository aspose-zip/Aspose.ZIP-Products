...
{{% blocks/products/pf/agp/content h2="How to Compress TEX File Using C#" %}}

 In order to compress or decompress TEX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for TEX Files Compression in C#" %}}
...
+  Define folder path containing TEX files.
...
+  Now you will get TEX file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress TEX Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "tex-files-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress TEX files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online TEX Compression Live Demos" sectionDescription="Compress TEX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
