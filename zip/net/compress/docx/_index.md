...
{{% blocks/products/pf/agp/content h2="How to Compress DOCX File Using C#" %}}

 In order to compress DOCX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for DOCX Files Compression in C#" %}}
...
+  Define folder path containing DOCX files.
...
+  Now you will get DOCX file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress DOCX Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "compress-docx-files.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online DOCX Compression Live Demos" sectionDescription="Compress DOCX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
