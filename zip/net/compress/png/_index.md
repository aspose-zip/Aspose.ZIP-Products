---
title: Compress PNG Images via C# 
weight: 410
url: /net/compress/png/ 
description: C# compression source code to compress PNG images into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress PNG Images in C#" h2="Native and high performance PNG image ZIP, TAR, GZIP, BZ2 archive compression using server-side API." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="PNG" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress PNG Using C#" %}}

 In order to compress or decompress PNG image, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for PNG Images Compression in C#" %}}
...
+  Define folder path containing PNG images.
...
<!-- aboutfile Starts -->
 ...
 Decompress PNG images right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online PNG Compression Live Demos" sectionDescription="Compress PNG documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
