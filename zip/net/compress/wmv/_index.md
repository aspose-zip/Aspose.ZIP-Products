---
title: Compress WMV Files via .NET 
weight: 690
url: /net/compress/wmv/ 
description: C# compression source code to compress WMV documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress WMV Formats in C#" h2="Native and high performance WMV document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="WMV" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress WMV File Using C#" %}}

 In order to compress WMV file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for WMV Files Compression in C#" %}}
...
+  Define folder path containing WMV files.
...
<!-- aboutfile Starts -->
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online WMV Compression Live Demos" sectionDescription="Compress WMV documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
        ...
        {{< blocks/products/pf/agp/about-file-text fileFormat="WMV" readMoreLink="https://docs.fileformat.com/video/wmv/" >}}
