---
title: Compress VTX Files via .NET 
weight: 1640
url: /net/compress/vtx/ 
description: C# compression source code to compress VTX documents into a single zip archive or vice versa on .NET Framework, .NET Core.
---

{{< blocks/products/pf/main-wrap-class isAutogenPage="true">}}
{{< blocks/products/pf/upper-banner h1="Compress VTX Formats in C#" h2="Native and high performance VTX document ZIP, 7Zip, TAR, GZIP, BZ2, LZ, CPIO, XZ, Z, CAB archive compression using server-side zip archive library." logoImageSrc="https://www.aspose.cloud/templates/aspose/img/products/zip/aspose_zip-for-net.svg" sourceAdditionalConversionTag="" additionalConversionTag="" pfName="" subTitlepfName="" downloadUrl="" fileiconsmall1="PNG" fileiconsmall2="JPG" fileiconsmall3="BMP" fileiconsmall4="TIFF" fileiconsmall5="VTX" >}}
...
{{% blocks/products/pf/agp/content h2="How to Compress VTX File Using C#" %}}

 In order to compress or decompress VTX file, we’ll use
...
{{% blocks/products/pf/agp/feature-section-col title="Steps for VTX Files Compression in C#" %}}
...
+  Define folder path containing VTX files.
...
+  Now you will get VTX file as a zip file in a relevant folder without using any zip, rar or any other compatible program.
...
{{% blocks/products/pf/agp/code-block title="Compress VTX Files - C#" offSpacer="" %}}

{{< gist "aspose-com-gists" "0e82250e6c3615557aaa48b2fee2486d" "vtx-files-compression.cs" >}}
...
<!-- aboutfile Starts -->
 ...
 Decompress VTX files right now by visiting our
 ...
 .
    ...
    {{< blocks/products/pf/agp/about-file-section >}}
        ...
        {{< blocks/products/pf/agp/demobox sectionTitle="Online VTX Compression Live Demos" sectionDescription="Compress VTX documents right now by visiting our [Live Demos website](https://products.aspose.app/zip/compression). The live demo has the following benefits" >}}
