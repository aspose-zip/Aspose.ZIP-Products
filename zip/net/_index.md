...
{{< blocks/products/pf/carousel-item h3="At a Glance" description="An overview of Aspose.ZIP for .NET API." >}}
...
{{< blocks/products/pf/carousel-item h3="Platform Independence" description="Aspose.ZIP for .NET supports any .NET framework starting from Standard 2.0 and can work on 32-bit & 64-bit operating systems." >}}
<div class="diagram1 d1-net">
 <div class="d1-row">
  <div class="d1-col d1-left">
  </div>
...
{{< blocks/products/pf/slr-element name="Source Code" href="https://github.com/aspose-zip/Aspose.ZIP-for-.NET" >}}
{{< blocks/products/pf/slr-element name="API References" href="https://apireference.aspose.com/zip/net" >}}
...
{{< blocks/products/pf/slr-tab tabTitle="Why Aspose.ZIP for .NET?" tabId="success-stories" >}}
